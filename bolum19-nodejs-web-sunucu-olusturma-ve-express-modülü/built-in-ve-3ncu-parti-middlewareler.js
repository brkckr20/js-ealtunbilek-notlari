...
//morgan kullanımı - middlewareler ile ilgili log kayıtlarını tutar.
const morgan = require('morgan');


app.use(express.json()); //post isteklerinin çalışması için gereklidir.
app.use(express.urlencoded({extended : true})); //isteklerin json değil de html form alanı gibi alanlardan geldiği zamanlarda kullanılır.
app.use(express.static("public")); //bu klasöre adres kısmında ulaşılabilmesini sağladık

app.use(morgan("common")); //içerik değişebilir. common ise istek yapan ip, tarih saat ve istek tipi ve sonucunu consola yazdırır.
